...
if($_POST){
	...
	if(empty($_POST['nome']) || empty($_POST['email'])){
		...
		$Email->Host = 'fourz.com.br'; //Servidor de envio # verificar qual o host correto com a hospedagem as vezes fica como smtp.
		$Email->Port = '465'; // Porta de envio
		$Email->SMTPSecure = 'ssl';
		$Email->Username = 'egidio@fourz.com.br'; //e-mail que será autenticado
		$Email->Password = 'pdnejoh2013'; // senha do email
		...
		$Email->AddAddress("egidioscneto@gmail.com"); //  para quem será enviada a mensagem
